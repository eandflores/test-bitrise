...
@TestOpen
@Named("create_venue_interactor")
class CreateVenueInteractor (
    ...
    private val responseMapper: VenueResponseMapper
        ...
        InputBoundary<VenueRequest, CreateVenueInteractor> {

    private lateinit var request : VenueRequest

    override fun input(input: VenueRequest): CreateVenueInteractor {
        this.request = input
        return this
    }
